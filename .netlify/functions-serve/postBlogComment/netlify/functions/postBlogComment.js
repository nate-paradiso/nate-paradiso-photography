...
// netlify/functions/postBlogComment.mjs
var postBlogComment_exports = {};
__export(postBlogComment_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(postBlogComment_exports);
...
async function handler(event, context) {
  try {
    ...
    const response = await axios_default.get(`https://api.jsonbin.io/v3/b/${BIN_ID}`, {
      headers: {
    ...
    const newComment = {
      id: jsonData[postIndex].comments.length + 1,
      name: comment.name,
      comment: comment.comment,
      timestamp: Date.now()
    };
    jsonData[postIndex].comments.push(newComment);
    await axios_default.put(`https://api.jsonbin.io/v3/b/${BIN_ID}`, jsonData, {
      headers: {
        "X-Master-Key": X_MASTER_KEY,
        "X-Access-Key": X_ACCESS_KEY,
    ...
    const updatedResponse = await axios_default.get(`https://api.jsonbin.io/v3/b/${BIN_ID}`, {
      headers: {
        "X-Master-Key": X_MASTER_KEY,
        "X-Access-Key": X_ACCESS_KEY
      }
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=postBlogComment.js.map
